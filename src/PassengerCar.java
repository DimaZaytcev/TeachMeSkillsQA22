...
class PassengerCar extends GroundTransport  {
    ...
    public void description()   {
        System.out.println();
        System.out.println("За время " + time + " ч, автомобиль " + getBrand() + " двигаясь с максимальной скоростью " + getMaxSpeed() + " проедет " + distance + " км и израсходует " + fuelConsumptionAllTime + " литров топлива.");
    }
